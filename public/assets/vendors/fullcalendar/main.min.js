...
var FullCalendar = (function (e) {
            ...
            e: if ("function" == typeof R) {
                if (
                    ...
                    null != d.componentWillUpdate &&
                        d.componentWillUpdate(S, d.__s, D),
    ...
    (i.unmount = function (e) {
        ...
        (ee.prototype.render = function (e, t) {
            ...
            return (
                o && (o.__h = null), [v(m, null, t.__e ? null : e.children), o]
            );
        });
    ...
    function qe(e, t, n) {
        return n.func
            ? n.func(e, t)
            : Ye(e[n.field], t[n.field]) * (n.order || 1);
    }
    function Ye(e, t) {
        return e || t
            ? null == t
            ...
            return (
                (e.prototype.splitProps = function (e) {
                    var t = this,
                        ...
                        u = {};
                    for (var c in ((this.eventUiBuilders = bt(
                        n,
                        function (e, n) {
    ...
    var Lo = (function (e) {
        ...
        return (
            ...
            (t.prototype.shouldComponentUpdate = function (e, t) {
                return (
                    this.debug &&
                        console.log(Rt(e, this.props), Rt(t, this.state)),
            ...
            function (e) {
                return (function (e, t, n, o, i) {
                    ...
                    return {
                        ...
                        buttonTextDefault:
                            p(i) || e.defaults.buttonText || p(cn) || e.type,
                        buttonTitleOverride:
                            f(o) || f(n) || e.overrides.buttonHint,
                        buttonTitleDefault:
                            f(i) || e.defaults.buttonHint || f(cn),
                    };
                })(e, a, t, n, o);
            }
        );
        ...
        zo({
            ...
            propSetHandlers: {
                dateProfile: function (e, t) {
                    t.emitter.trigger(
                        "datesSet",
                        r(r({}, hr(e.activeRange, t.dateEnv)), {
                            view: t.viewApi,
                        })
                    );
                },
    ...
    var Ni = (function () {
        function e(e) {
            ...
            (this.computeOptionsData = qt(this._computeOptionsData)),
                (this.computeCurrentViewData = qt(
                ...
                for (var f in a)
                    a[f] === u[f] || (fn[f] && fn[f](a[f], u[f]))
                        ...
                        : (a[f] === this.currentCalendarOptionsInput[f] ||
                          (fn[f] &&
                              fn[f](a[f], this.currentCalendarOptionsInput[f]))
            ...
            !(
                ...
                !(function (e, t, n, o) {
                    ...
                    for (var m in u) {
                        var y = u[m],
                            ...
                            S = c[y.defId],
                            b = l[y.defId];
                        if (!Oa(S.constraints, E, d, e.businessHours, t))
                            return !1;
                        ...
                        for (
                            var _ = i.eventStore, T = 0, k = S.allows;
                            T < k.length;
                            T++
                        ) {
                            var x = k[T],
                ...
                !(
                    ...
                    !(function (e, t, n, o) {
                        ...
                        o && (c = o(c));
                        if (!Oa(c.constraints, u, i, e.businessHours, t))
                            return !1;
                        ...
                        for (var f in s) {
                            ...
                            if (qn(u, h.range)) {
                                ...
                                if (p && !p(new xr(t, a[h.defId], h), null))
                                    return !1;
                            }
                        }
                        for (var v = 0, g = c.allows; v < g.length; v++) {
                            if (!(0, g[v])(yr(r(r({}, n), l), t), null))
                                return !1;
                        }
                        return !0;
                    })(e, t, n, o)
        ...
        return (
            ...
            (t.prototype.render = function () {
                ...
                return _o(
                    ...
                    Boolean(!v && p.length) &&
                        _o.apply(void 0, o(["thead", g], p)),
                    Boolean(!v && f.length) &&
                        _o.apply(void 0, o(["tbody", g], f)),
                    Boolean(!v && h.length) &&
                        _o.apply(void 0, o(["tfoot", g], h)),
            ...
            (t.prototype.computeShrinkWidth = function () {
                return Xa(this.props.cols)
                    ? Ba(this.scrollerElRefs.getAll())
                    : 0;
            }),
    ...
    var us = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.refineHookProps = Yt(ls)), (t.normalizeClassNames = Jo()), t
            );
        }
        return (
            n(t, e),
    ...
    function ps(e) {
        return (
            e.event.title &&
            _o("div", { className: "fc-event-title" }, e.event.title)
        );
    }
    var fs = function (e) {
        return _o(Oo.Consumer, null, function (t) {
    ...
    function Es(e) {
        if (e.allDayDate)
            return { start: e.allDayDate, end: tt(e.allDayDate, 1) };
        var t,
            n = e.hiddenSegs;
        return {
            start: Ss(n),
        ...
        Ts = (function () {
            function e(e) {
                ...
                (this.subjectEl = null),
                    ...
                    1 === (Rs += 1) &&
                        window.addEventListener("touchmove", ks, {
                            passive: !1,
                        });
            }
            return (
                (e.prototype.destroy = function () {
                    this.containerEl.removeEventListener(
                        ...
                        (Rs -= 1) ||
                            window.removeEventListener("touchmove", ks, {
                                passive: !1,
                            });
                }),
                (e.prototype.tryStart = function (e) {
                    ...
                    return (
                        !(
                            !t ||
                            (this.handleSelector && !Se(n, this.handleSelector))
                        ) &&
                        ((this.subjectEl = t),
                        (this.isDragging = !0),
                        (this.wasTouchScroll = !1),
    ...
    var xs = (function () {
            ...
            return (
                ...
                (e.prototype.cleanup = function () {
                    this.mirrorEl &&
                        (Ee(this.mirrorEl), (this.mirrorEl = null)),
                        (this.sourceEl = null);
                }),
    ...
    function Us(e, t) {
        return (
            (!e && !t) ||
            (Boolean(e) === Boolean(t) && fr(e.dateSpan, t.dateSpan))
        );
    }
    function Ws(e, t) {
        for (
        ...
        function t(n) {
            ...
            (o.subjectEl = null),
                ...
                (o.handlePointerDown = function (e) {
                    ...
                    var d =
                        r.isValidSegDownEl(t) && !Se(t, ".fc-event-resizer");
                    i.setIgnoreMove(!d),
                        (o.isDragging =
                            d &&
            ...
            return (
                ...
                (e.prototype.computeTimeTop = function (e) {
                    var t,
                        ...
                        i = r.els.length,
                        a =
                            (e.milliseconds - Ut(o.slotMinTime)) /
                            Ut(this.slotDuration);
                    return (
                        (a = Math.max(0, a)),
                        (a = Math.min(i, a)),
                        (t = Math.floor(a)),
    ...
    var iu = (function (e) {
        function t() {
            var t = (null !== e && e.apply(this, arguments)) || this;
            return (
                (t.buildTimeColsModel = qt(au)), (t.buildSlatMetas = qt(ou)), t
            );
        }
        return (
            n(t, e),
